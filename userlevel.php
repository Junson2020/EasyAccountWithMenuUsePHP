...
echo " <caption><font color='black' size='3'>".GetLangStr($junsonlanguage,"Select User To Setup Level")."</font></caption>";
echo "<thead>";
...
for($i=0;$i < $n;$i++) {
  ...
  if($showflag==1) {
    ...
    echo "<td width='200' align='center'><a href='userleveledit.php?param=".$randsnA."'><img src=images/pencil.png width='24'></img></a></td>";
